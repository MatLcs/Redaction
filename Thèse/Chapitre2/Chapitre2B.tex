...
\label{chap:ch2}
	...
	\begin{figure}[h]
	\centering
		\includegraphics[width=.5\linewidth]{Chapitre2/Figures/Poulain.jpg}
	\end{figure}
	
	\begin{figure}[h]
	\centering
		\includegraphics[width=.5\linewidth]{Chapitre2/Figures/GelRhone.jpg}	
	\end{figure}
...
\FloatBarrier
	...
	\subsection{Évolution temporelle des enjeux en zone inondable}
