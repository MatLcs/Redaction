...
\section{Introduction}
	...
	\begin{frame}[c]
		...
		\vspace{3pt}
		\begin{center}
			\includegraphics<1>[width = .25\textwidth]{./Figures/LogoHydro.pdf}
...
%		\end{minipage}
	...
	\begin{frame}%[c]
		\frametitle{Incertitude d'échantillonnage}
      	\begin{itemize}
			\item<2->[$\vartriangleright$] Longueur des chroniques de débit limitée $\Rightarrow$ 60 ans en moyenne en France\footfullcite{le_coz_quantifying_2017}
			\vspace{2pt}
	...
	\begin{frame}[c]
		...
		\begin{minipage}[t]{0.49\textwidth}
			...
			\vspace{7pt}
			\centering
			\includegraphics<4>[width = \textwidth]{./Figures/HistoFloods1.pdf}%\phantom{s}\\
			\includegraphics<5-6>[width = \textwidth]{./Figures/HistoFloodsAll.pdf}%\phantom{s}\\
			\includegraphics<7->[width = .95\textwidth]{./Figures/HistoFloodsRed.pdf}\phantom{s}\\
			\vspace{1pt}
...
%	      		\includegraphics<3>[width = \columnwidth]{./Figures/Avi2003.jpg} 
	...
	\begin{frame}%[c]
		...
		\centering
      	\includegraphics[width = .7\textwidth]{./Figures/HistoFloods1.pdf}
	\end{frame}	
...
%	      		\includegraphics<1>[width = \textwidth]{./Figures/PtBcr.png} 
	...
	\begin{frame}%[c]
		...
		\vfill
		\centering
		\includegraphics[width = .8\textwidth]{./Figures/carto.pdf} 
	\end{frame}
...
\begin{minipage}{.45\textwidth}
		...
		\begin{minipage}{.54\textwidth}
			\begin{center}
	      		...
	      		\includegraphics<3>[width = .62\columnwidth]{./Figures/CatHistrhone.png}
	      		\includegraphics<4>[width = .9\columnwidth]{./Figures/Nb_C3-C4.pdf}\phantom{s}\\
				\vspace{1pt}				
...
\section{Estimation des débits} 
    ...
    \begin{frame}
    		...
    		\vspace{15pt}
    		\begin{center}
    		\includegraphics<1>[width = .7\textwidth]{./Figures/HistoFloods1.pdf} 
...
%			\includegraphics<4>[width = .44\textwidth]{./Figures/SchemaProp0.pdf} 	
	...
	\begin{frame}
		...
		\begin{center}
			\includegraphics<1>[width = .5\textwidth]{./Figures/BathyPt.pdf} 
			\includegraphics<2>[width = .7\textwidth]{./Figures/EditArmand.pdf} 
			\includegraphics<3>[width = .6\textwidth]{./Figures/Goux4550.png} 
			\includegraphics<4>[width = .7\textwidth]{./Figures/ProfilsBardRestit.png} 
		\end{center}	
	\end{frame}    
...
\section{Analyse fréquentielle}
	...
	\begin{frame}
		...
		\vfill
		\centering
		\onslide<4> Quelle est la part de chacune de ces deux incertitudes dans l'incertitude totale des quantiles ? 
	 \end{frame}
	...
	\begin{frame}
		...
		\vfill
		\begin{itemize}
			\item [$\vartriangleright$] Crues > Seuil de perception $\Rightarrow$ apparaissent dans les données historiques
			\vfill
			\item [$\vartriangleright$] Années sans mentions de crue < Seuil de perception
			\vfill
			\item [$\vartriangleright$] Connaissance du débit des crues historiques $\Rightarrow$ pas nécessaire : nombre de dépassements du seuil suffisant \textsuperscript{16;}\footfullcite{payrastre_usefulness_2011}
		\end{itemize}
	\end{frame}
...
%	\subsection{Modèle fréquentiel et incertitudes}
	\begin{frame}
	...
	\begin{frame}
		...
		\vfill
		\begin{itemize}
			\item [$\vartriangleright$] Pont de Beaucaire (1816-1970) : Nombre de dépassements du seuil S = 9000 m\textsuperscript{3}/s
			\vspace{5pt}			
			\item [$\vartriangleright$] Beaucaire Restitution (1971-2020) : L'ensemble des débits maximum annuels avec incertitude
		\end{itemize}
	\end{frame}
	...
	\begin{frame}[c]
		...
		\begin{itemize}
			\item [$\vartriangleright$] Méconnaissance de $S$ $\Rightarrow$ plus impactante que méconnaissance de $n$
			\vfill
			\item [$\vartriangleright$] Distribution \textit{a posteriori} de $n$ relativement large
			\vfill
			\item [$\vartriangleright$] Corrélations entre $S$ et $n$
		\end{itemize}
	\end{frame}
