...
%		\begin{center} $\Rightarrow$ \Large{optimisme ?}\\ \end{center}
		...
		\vfill
		\centering
			\includegraphics<1-2>[width = .4\textwidth]{./Figures/SN_uSuN1.pdf}
			\includegraphics<3->[width = .4\textwidth]{./Figures/SN_uSuN.pdf}
		\vfill
	\end{frame}
	...
	\begin{frame}%[c]
		...
		\begin{minipage}{.5\textwidth}
			\begin{itemize}
				...
				\vspace{10pt}
				\item<2->[$\vartriangleright$] Dernière station du Rhône complet\\
				\vspace{10pt}
