...
%+ souligner la construction du canal de Beaucaire à la mer + dates construction
...
%	\resizebox{\columnwidth}{!}{%  
       \begin{tabular}{| m{2cm} | m{2.8cm}| m{2.2cm} | m{3.3cm} | m{2.5cm} | m{2.5cm} |} 
                \hline
